...
data_prefix='NWPU-RESISC45'
train_ann_file='NWPU-RESISC45/val_20per.txt'
val_ann_file='NWPU-RESISC45/train_80per.txt'
train_batch_size = 32
val_batch_size = 64
train_pipeline = [
...
############训练配置############
work_dir = './work_dirs/SceneClassification/CGEarthEye-Giant-518-RESISC45'
val_interval = 1
