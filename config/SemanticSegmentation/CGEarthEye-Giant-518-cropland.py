############数据集配置############
dataset_type = 'RsimageDataset'
dataset_root = './datasets/SemanticSegmentation/cropland/'
image_size = (518,518)
backend_args = None
train_pipeline = [
...
test_dataloader = dict(
    batch_size=8,
    dataset=dict(
        data_prefix=dict(img_path='test/Img', seg_map_path='test/Label'),
        data_root=dataset_root,
